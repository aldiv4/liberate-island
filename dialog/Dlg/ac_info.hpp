...
class acInfoDLG
{
	...
	objects[] = {};
	controls[] = { MM_TAG, infomainmission, infosidemission, MM_BtnOk, MM_BtnOpt, MM_BtnHBfix, MM_Label, MM_WELMSG, MM_SCORE, MM_ACCURANCY, MM_AMMOUSED, MM_PLAYERROLE, MM_KILLNUMBER, MM_LEADER, MM_RANK, MM_IALEVEL};
	...
	class MM_TAG : RscPicture
	{
		...
		text = "dialog\pics\escapefromhell2.paa";
	};
