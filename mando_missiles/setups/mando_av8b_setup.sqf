...
[]spawn
{
   ...
   [["AV8B", "AV8B2"], 0, 0, ["Vehicles", "REMOTE"], "MMA LGB Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(driver _plane == player) && ("BombLauncher" in weapons _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";


// BIS AV8B2 and AV8B HUDs
   [["AV8B2","AV8B"], 0, "", [4,6], [4,6], 15, 15, 20, [4,3,-2.5], mando_missile_path+"huds\mando_hud_av8b2.sqf", 0, 0, [[-7,"SidewinderLaucher_AH1Z"],[-6, "Mk82BombLauncher_6"]], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
