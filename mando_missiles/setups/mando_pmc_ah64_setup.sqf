...
[]spawn
{
   ...
   [["PMC_AH64_closesupport", "PMC_AH64_multirole"], 0, 0, ["Vehicles", "REMOTE"], "MMA Hellfire Camera", _mcctypeaascript, [-3,2,-2], [0,6.5,-0.5,0,181], {(driver _plane == player) && !(isPlayer gunner _plane)}, 0, -5, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";


   // AH1-Z cameras setup (8 onboard hellfires)
   _mcctypeaascript = "mando_missiles\tv\tv_types\mando_tv_hellfire_pmc.sqs";
   [["PMC_AH64_closesupport", "PMC_AH64_multirole"], 0, 0, ["Vehicles", "REMOTE"], "MMA Hellfire Camera", _mcctypeaascript, [-3,2,-2], [0,6.5,-0.5,0,181], 1, 0, -5, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";
