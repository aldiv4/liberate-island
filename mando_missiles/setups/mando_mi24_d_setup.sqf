...
[]spawn
{
   ...
   // BIS Mi24_D cameras setup (onboard AT2)
   ...
   _mcc_tv_script = mando_missile_path+"tv\tv_types\mando_tv_at2_mi24d.sqs";
   ...
   [["Mi24_D"], 0, 0, ["Vehicles"], "MMA Falanga Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(driver _plane == player) && !(isPlayer gunner _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

   [["Mi24_D"], 0, 0, ["Vehicles"], "MMA Falanga Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, 1, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";



// Mi24_P HUD setup for pilot
   [["Mi24_D"], 0, "", [], [], 15, 15, 0, [4,3,-2.5], mando_missile_path+"huds\mando_hud_locations.sqf", 0, 0.07, [], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";


// Mi24_P HUD setup for gunner
   [["Mi24_D"], 1, "", [], [], 15, 15, 0, [4,3,-2.5], "", 0, 0.07, [], 1]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
