...
[]spawn
{
   ...
   [["HEXA_Tiger_HAP_CE","HEXA_Tiger_HAD_CE"], 0, "sight", [4], [4], 15, 15, 0, [4,3,-2.5], mando_missile_path+"huds\mando_hud_hexa_tigre.sqf", 0, 0, [[-1,"HEXA_MistralLauncher"]], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
