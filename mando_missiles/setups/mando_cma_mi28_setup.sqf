...
[]spawn
{
   ...
   [["CMA_Mi28_RUS"], 0, 0, ["Vehicles"], "MMA Ataka-V Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(driver _plane == player) && !(isPlayer gunner _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

   [["CMA_Mi28_RUS"], 0, 0, ["Vehicles"], "MMA Ataka-V Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, 1, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";



// Mi28 HUD setup for pilot
   [["CMA_Mi28_RUS"], 0, "", [], [], 15, 15, 0, [4,3,-2.5], mando_missile_path+"huds\mando_hud_locations.sqf", 0, 0.08, [], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";


// Mi28 HUD setup for gunner
   [["CMA_Mi28_RUS"], 1, "", [], [], 15, 15, 0, [4,3,-2.5], "", 0, 0.08, [], 1]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
