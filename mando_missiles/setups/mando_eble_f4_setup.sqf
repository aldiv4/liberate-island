...
*/
   ...
   [["4emesh","4emesh2","4emeshracs"], 8, 8, ["Air"], "MMA RIO Console", _mcctypeaascript, [3,2,-3], [0,7.5,-1.6], {(gunner _plane == player) && ("RKTF4SparrowRail" in weapons _plane)}, 0, "RKTF4SparrowRail", [], 2]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

   _mcctypeaascript = "mando_missiles\mcc\mcc_types\mando_missilecontrolon_eble_agm88.sqs";
   [["4emesh","4emesh2","4emeshracs"], 8, 8, ["RADAR"], "MMA AGM-88 HARM", _mcctypeaascript, [3,2,-3], [0,7.5,-1.6], {(gunner _plane == player) && ("RKTF4HarmRail" in weapons _plane)}, 0, "RKTF4HarmRail", [], 2]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";

// HUD Systems setup

// F4 Pilot's HUD
   [["4emesh","4emesh2","4emeshracs"], 0, "", [4,6], [4,6], 15, 15, 20, [4,3,-2.5], mando_missile_path+"huds\mando_hud_eble_f4.sqf", 0, 0, [[-6,"GLT_SidewinderXLauncher"],[-8,"GLT_AIM120Launcher"],[-7,"GLT_AIM7Launcher"]], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";

// F4 HUD setup for gunner
   [["4emesh","4emesh2","4emeshracs"], 1, "", [], [], 15, 15, 0, [4,3,-2.5], "", 0, 0.07, [], 1]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
