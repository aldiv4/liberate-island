...
[]spawn
{
   ...
   [["AH1Z", "ACE_AH1Z_AGM_W", "ACE_AH1Z_AGM_D", "ACE_AH1Z_AGM_AGM_D", "ACE_AH1Z_AGM_AGM_W"], 0, 0, ["Vehicles", "REMOTE"], "MMA AGM-114K", _mcctypeaascript, [-3,2,-2], [0,6.5,-0.5,0,181], {(driver _plane == player) && ("ACE_HellfireLauncher" in weapons _plane) && !(isPlayer gunner _plane)}, 0, -6, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";
   
   // AH1-Z cameras setup - Gunner - AGM-114K (laserguided)
    _mcctypeaascript = "mando_missiles\tv\tv_types\mando_tv_hellfire_ace.sqs";
   [["AH1Z", "ACE_AH1Z_AGM_W", "ACE_AH1Z_AGM_D", "ACE_AH1Z_AGM_AGM_D", "ACE_AH1Z_AGM_AGM_W"], 0, 0, ["Vehicles", "REMOTE"], "MMA AGM-114K", _mcctypeaascript, [-3,2,-2], [0,6.5,-0.5,0,181], {(gunner _plane == player) && ("ACE_HellfireLauncher" in weapons _plane)}, 0, -6, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";
