...
//   cutText[_msg, "PLAIN DOWN"];
   ...
   _ah = _plane addAction ["<t color=""#00ccdd"">MMA Toggle HUD", mando_missile_path+"units\mando_togglemissilehud.sqf","",95,false,true];  
   ...
   {
      _ak = _plane addAction ["<t color=""#00ccdd"">MMA Change Keys", mando_missile_path+"units\mando_keyconfig.sqf","",93,false, true]; 
   };
