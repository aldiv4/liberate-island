...
if (((currentWeapon vehicle player) == "Laserdesignator") && (alive vehicle player)) then
{
   (_this select 0) addAction ["Transmit laser target", mando_missile_path+"units\mando_getlaser.sqf"];
};