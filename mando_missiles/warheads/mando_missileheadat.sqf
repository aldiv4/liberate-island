// mando missile warhead type AT
// mando_missileheadat.sqf v1.0
// Jan 2007 Mandoble
// 
...
// low power explosion (equivalent to Javelin missile).
...
if (local _target) then
{
   ...
   _b2 setPos _pos2;
   _b1 = "M_TOW_AT" createVehicle (_b2 modelToworld [0,0,0]);
   sleep 0.5;
   deleteVehicle _b2;
};
