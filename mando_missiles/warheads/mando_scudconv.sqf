...
if (local _target) then
{
   ...
   _posb = [_pos select 0, _pos select 1, _pos select 2];
   _bx1 = "Bomb" createVehicle _posb;
   _bx1 setPos _posb;
   _b1 = "Bo_GBU12_LGB" createVehicle (_bx1 modelToworld [0,0,0]);


   _posb = [(_pos select 0)-15,(_pos select 1)-15, _pos select 2];
   _bx2 = "Bomb" createVehicle _posb;
   _bx2 setPos _posb;
   _b1 = "Bo_GBU12_LGB" createVehicle (_bx2 modelToworld [0,0,0]);


   _posb = [(_pos select 0)+15,(_pos select 1)-15, _pos select 2];
   _bx3 = "Bomb" createVehicle _posb;
   _bx3 setPos _posb;
   _b1 = "Bo_GBU12_LGB" createVehicle (_bx3 modelToworld [0,0,0]);

   _posb = [(_pos select 0),(_pos select 1)+15, _pos select 2];
   _bx4 = "Bomb" createVehicle _posb;
   _bx4 setPos _posb;
   _b1 = "Bo_GBU12_LGB" createVehicle (_bx4 modelToworld [0,0,0]);
