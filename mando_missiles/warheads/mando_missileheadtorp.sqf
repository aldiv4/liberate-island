// mando missile warhead for torpedoes
// mando_missileheadtorp.sqf v1.0
// Jan 2007 Mandoble
// 
...
// Powerful explosion, similar to Bo_GBU12_LGB hit.
...
_crewt = crew _target;
_cost = getNumber (configFile >> "CfgVehicles" >> (typeof _target) >> "cost");
...
{
   _b1 = "Bomb" createVehicle _pos;
   _b1 setPos _pos;
;   _b2 = "Bomb" createVehicle [_pos select 0,_pos select 1,1];
;   _b2 setPos [_pos select 0,_pos select 1,1];
   _b1 setDamage 1;
;   _b2 setDamage 1;
