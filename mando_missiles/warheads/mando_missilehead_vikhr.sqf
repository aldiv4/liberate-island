// mando missile warhead type Vikhr
// mando_missileheadvikrh.sqf v1.0
// Jan 2009 Mandoble
// 
...
// low power explosion (equivalent to a hand grenade).
...
if (local _target) then
{
   ...
   _b2 = "Barrel4" createVehicle _pos2;
   _b2 setPos _pos2;
   _b1 = "M_Vikhr_AT" createVehicle (_b2 modelToworld [0,0,0]);
   sleep 0.5;
   deleteVehicle _b2;
};
